# Manually Switching Dark and Light Mode in Ionic App
...
<ion-content [fullscreen]="true">
  <ion-list>
    <ion-item>
      ...
      <ion-toggle slot="end" mode="ios" [checked]="isDark" (ionChange)="toggleDark($event)"></ion-toggle>
    </ion-item>
  </ion-list>
</ion-content>
````
